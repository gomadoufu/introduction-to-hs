...
/* package parallel-sample-0.1.0.0 */
#ifndef VERSION_parallel_sample
#define VERSION_parallel_sample "0.1.0.0"
#endif /* VERSION_parallel_sample */
#ifndef MIN_VERSION_parallel_sample
#define MIN_VERSION_parallel_sample(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_parallel_sample */
...
#define CURRENT_COMPONENT_ID "parallel-sample-0.1.0.0-8gXB8umiGsa2cu5sKcIWN7-multi-processors"
